...
%SYNCHRONIZE_DATA
%   Takes two time series (dates + values) and synchronizes them over their
%   common time interval.
%
% INPUTS:
%   - dates1, temp1 : date vector and values for the first series
%   - dates2, temp2 : date vector and values for the second series
%
% OUTPUTS:
