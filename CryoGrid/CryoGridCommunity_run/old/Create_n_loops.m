...
% diagnostic_run(TAll, dtEnd, source_path, init_format, constant_file, result_path, numLoops);
% 
% % -------------------------------------------------------------------------
% %                             PART III
...
% write_individual_loop_folders(TRun, dtEnd, result_path, numLoops, init_format, constant_file, ext_dict);
% 
% % -------------------------------------------------------------------------
% %                             PART IV
...
% % -------------------------------------------------------------------------
% 
% run_names = arrayfun(@(k) sprintf('loop%d', 2*k-1), ...
