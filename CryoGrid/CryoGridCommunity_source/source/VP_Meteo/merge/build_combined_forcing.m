function build_combined_forcing(out_path)
%BUILD_COMBINED_FORCING Assemble all merged SAFRAN-ERA5 files.
%
% DESCRIPTION
%   Collects all individual CryoGrid-ready forcing files produced by:
%
%       merge_SAFRAN_ERA5()
%
%   and combines them into a single structure grouped by SAFRAN massif.
%
%   Each massif contains:
%
%       FORCING(m).name
%       FORCING(m).massif_num
%       FORCING(m).lon
%       FORCING(m).lat
%       FORCING(m).polygon
%       FORCING(m).data
...
%       S_TOA      [Nt x 1]
%
%   and elevation-dependent variables:
%
%       Tair
%       Lin
%       Sin
...
% INPUT
%   out_path
%       Folder containing the merged SAFRAN-ERA5 forcing files:
%
%           safran_forcing_massif_*.mat
%
%
% OUTPUT
%   Saves:
...
%
%   containing the complete CryoGrid forcing collection.
%
%
% SEE ALSO
%   MERGE_SAFRAN_ERA5
