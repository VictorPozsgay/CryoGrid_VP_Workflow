%========================================================================
% CryoGrid OUT class OUT_last_timestep_VP
...
% 
% Allows for extra tags with tile number and date to prevent overwriting
% 
...
classdef OUT_last_timestep_VP < OUT_BASE
        ...
        function out = store_OUT(out, tile)
            ...
            if t>=out.SAVE_TIME || t >= out.OUTPUT_TIME
                ...
                % OUT_regridded-style naming + spinup tagging
                    ...
                    if isfield(tile.PARA, 'class_index')
                        spinup_tag = sprintf('_tile%d', ...
                            tile.PARA.class_index);
                    end
