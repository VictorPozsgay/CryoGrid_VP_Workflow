...
The output dataset is located at /forcing/Forcing_Data/LiDAR_HD_DEM_10m/ (but the data is too large to be stored on GitHub)
...
![LiDAR DEM overview](/forcing/DEM_Script_VP/LiDAR_HD_DEM/diagnostics/LiDAR_HD_DEM_massifs.png)
...
![Missing LiDAR pixels](/forcing/DEM_Script_VP/LiDAR_HD_DEM/diagnostics/LiDAR_HD_DEM_missing_pixels.png)
